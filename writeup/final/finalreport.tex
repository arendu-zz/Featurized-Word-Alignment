...
\end{tabular}
\label{tab:rc}
\caption{Performance of the algorithms with different Regularization coefficients, trained on 2K sentences and tested on 200, only with base features}
\end{table*}

\begin{table}[h]
\begin{tabular}{llll}
\textbf{Algorithm} & \textbf{Regularization} & \textbf{NThreads} & \textbf{Time} \\
FEM       & 0.0            & 24       & 65m17s  \\
FEM       & 0.005          & 24       & 65m9s   \\
DGD       &                & 24       &         \\
DGD       &                & 24       &         \\
FEM-SGD   & 0.0            & 1        & 113m14s \\
FEM-SGD   & 0.005          & 1        &         \\
FEM-SGD-P & 0.0            & 24       & 24m36s  \\
FEM-SGD-P & 0.005          & 24       & 24m21s 
\end{tabular}
\label{tab:time}
\caption{Time of the algorithms with 5 iterations 2K sentences and tested on 200, only with base features}
\end{table}
...
\end{tabular}
\label{tab:sgdp}
\caption{Performance FEM-SGD-P trained on 5K sentences (5 iterations) and tested on 200}
\end{table}
